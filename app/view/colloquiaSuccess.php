    ...
    <div class="container">
        <div class="row align-items-center min-vh-75 min-vh-lg-100">
            <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center" style="z-index: 2;">
                <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">Collaques</h1>
                <p class="mb-4 fs-1">Mes collaques servent à ...</p><a class="btn btn-lg btn-success" href="#events"
                    role="button">Découvrir mes collaques!</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 mx-auto text-center mb-3">
                <h5 class="fw-bold fs-3 fs-lg-5 lh-sm mb-3">Collaques</h5>
                <p class="mb-5">Liste des collaques à venir.</p>
            </div>
        </div>
        <div class="row flex-center h-100">
            <div class="col-xl-9">
                <div class="row">
                    <div class="col-md-4 mb-5" foreach="colloquia" style="cursor:pointer" onclick="subscribe(this)">
                        ...
                        <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                            <div class="text-center text-md-start card-hover"><img class="ps-3 icons"
                                    src="images/colloquia.svg" height="60" alt="" />
                                <div class="card-body">
                                    ...
                                    <p class="mt-3 mb-md-0 mb-lg-2">Places restantes: <span
                                            foreach-value="availablePlaces" class="available-places"></span></p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="js/event/colloquia.js"></script>
